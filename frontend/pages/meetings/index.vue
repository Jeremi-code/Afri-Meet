      ...
      <div class="rounded-lg shadow-md p-4 md:p-6 space-y-4" v-for="createdMeeting in createdMeetingsList">
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-center gap-2">
            <RescheduleModal :room="createdMeeting.room" :participants="createdMeeting.participants" :external_participants="createdMeeting.external_participants" :meeting_id="createdMeeting.meeting_id" :title="createdMeeting.title"/>
